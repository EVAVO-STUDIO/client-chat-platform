...
const moduleUrl = `data:text/javascript;base64,${Buffer.from(emitted, "utf8").toString("base64")}`;
...
expectError(classify, { messages: [42] }, "model_request_shape_not_approved");
expectError(
  classify,
...
console.log("- the executed classifier uses in-memory transpilation and leaves no checkout files");
